...
const Hero = () => (
  ...
  <section id="hero" className="w-full flex items-center justify-between my-md:gap-8 gap-48 my-md:flex-row flex-col">
    <div>
    ...
    <div className="z-10 relative my-sm:block hidden">
